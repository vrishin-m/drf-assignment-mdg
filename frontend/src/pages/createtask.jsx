    ...
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.feed}>
          <h3 style={styles.feedHeader}>Recent Tasks ({tasks.length})</h3>
          
          {tasks.length === 0 ? (
            <p style={styles.emptyText}>cant be empty</p>
          ) : (
...
const styles = {
  ...
  feedHeader: { margin: '0 0 16px 0', fontSize: '16px', color: '#2d3748' },
  emptyText: { color: '#a0aec0', fontSize: '14px', fontStyle: 'italic' },
  taskList: { display: 'flex', flexDirection: 'column', gap: '12px' },
  taskCard: { backgroundColor: '#fff', padding: '16px', borderRadius: '6px', border: '1px solid #e2e8f0' },
  taskTitle: { margin: '0 0 8px 0', fontSize: '16px', color: '#1a202c' },
  taskDesc: { margin: '0 0 12px 0', fontSize: '14px', color: '#4a5568' },
  labelRow: { display: 'flex', gap: '8px', flexWrap: 'wrap' },
  pill: { padding: '4px 10px', borderRadius: '16px', fontSize: '12px', fontWeight: '600', display: 'inline-block' }
};